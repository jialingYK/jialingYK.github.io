...
<div class="p-4">
    ...
    <div class="embed-responsive embed-responsive-16by9 rounded-xl">
        <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/videoseries?list={{ page.youtube_playlist }}" title="On Repeat playlist" loading="lazy" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>
    </div>
